...
#include "CommandLineParser_meta.h"
...
/// USER_SECTION_END
	...
	public:
		...
		static constexpr int versionMajor				= CommandLineParser_VERSION_MAJOR;
		static constexpr int versionMinor				= CommandLineParser_VERSION_MINOR;
		static constexpr int versionPatch				= CommandLineParser_VERSION_PATCH;
		...
		static constexpr const char* name				= CommandLineParser_LIBRARY_NAME;
